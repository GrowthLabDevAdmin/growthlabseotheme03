!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ...
      : e(
          ((t =
            "undefined" != typeof globalThis ? globalThis : t || self).IMask =
            {}),
        );
})(this, function (t) {
  "use strict";
  ...
  function r(t, e) {
    ...
    if (e && t && "object" == typeof e && "object" == typeof t) {
      ...
      for (a = 0; a < h.length; a++)
        if (!Object.prototype.hasOwnProperty.call(t, h[a])) return !1;
  ...
  class f {
    ...
    _onInput(t) {
      ...
      (u !== a.NONE && (n = this.masked.nearestInputPos(n, a.NONE)),
  ...
  class C {
    ...
    _appendChar(t, e, s) {
      ...
      if (
        ...
        t &&
          ...
          !a.rawInserted && "pad" === this.autofix))
      ) {
        const s = this.state;
        this.state = i;
        let u = this.pad(e);
        ...
        ((u = u.aggregate(n)),
          n.rawInserted || u.equals(a) ? (a = u) : (this.state = s));
      }
      if (a.inserted) {
        let t,
        ...
        if (u && null != s) {
          ...
          if (!0 === this.overwrite) {
            t = s.state;
            for (let t = 0; t < a.rawInserted.length; ++t)
              s.unshift(this.displayValue.length - a.tailShift);
          }
          let i = this.appendTail(s);
          if (
            ((u = i.rawInserted.length === s.toString().length),
            !((u && i.inserted) || "shift" !== this.overwrite))
          ) {
    ...
    splice(t, e, s, i, n) {
      ...
      if (
        (i !== a.NONE &&
          ((p = this.nearestInputPos(t, e > 1 && 0 !== t && !o ? a.NONE : i)),
          (d.tailShift = p - t)),
    ...
    appendTo(t) {
      ...
      for (let s = 0; s < this.chunks.length; ++s) {
        ...
        if (
          (null != u &&
            (!a || a.index <= u) &&
            ((i instanceof A || t._stops.indexOf(u) >= 0) &&
              e.aggregate(t._appendPlaceholder(u)),
            (n = i instanceof A && t._blocks[u])),
          n)
        ) {
  ...
  class F {
    ...
    pushLeftBeforeInput() {
      return this._pushLeft(() => {
        if (!this.block.isFixed)
          return (
            (this.offset = this.block.nearestInputPos(this.offset, a.LEFT)),
            !0
          );
      });
    }
    ...
    pushRightBeforeInput() {
      return this._pushRight(() => {
        if (!this.block.isFixed)
          return (
            (this.offset = this.block.nearestInputPos(this.offset, a.NONE)),
            !0
          );
      });
    }
    ...
    _appendCharRaw(t, e) {
      ...
      for (let u, n = s.index; (u = this._blocks[n]); ++n) {
        ...
        const s = u._appendChar(t, {
          ...e,
          _beforeTailState:
            null == (a = e._beforeTailState) || null == (a = a._blocks)
              ? void 0
              : a[n],
        });
            ...
            : e === a.FORCE_RIGHT
              ...
              : (s.popState(),
                s.ok
                  ? s.pos
                  : (s.popState(),
                    s.ok ? s.pos : this.nearestInputPos(t, a.LEFT))))
        : t;
    }
    totalInputPositions(t, e) {
      (void 0 === t && (t = 0), void 0 === e && (e = this.displayValue.length));
  ...
  class D extends b {
    ...
    _update(t) {
      ...
      ((u.mask =
        r.slice(0, h).replace(/0/g, "\\0") + "0".repeat(this.maxLength - h)),
        super._update(u));
    }
    get isComplete() {
      ...
      return Number(u) < this.from
        ...
        : Number(a) > this.to
          ? !e.tail &&
            ...
            ? super
                ._appendCharRaw(s[this.value.length], e)
          ...
          (this.currentMask !== r
            ? (this.currentMask.reset(),
              u &&
                ...
                (h.tailShift = this.currentMask.value.length - i.length)),
              n &&
                (h.tailShift += this.currentMask.append(n, {
                  raw: !0,
                  tail: !0,
                }).tailShift))
        ...
        n = e.compiledMasks.map((n, r) => {
          const h = e.currentMask === n,
            o = h
              ...
              : n.nearestInputPos(n.displayValue.length, a.FORCE_LEFT);
          return (
            n.rawInputValue !== u
              ? (n.reset(), n.append(u, { raw: !0 }))
              : h || n.remove(o),
  ...
  class I extends b {
    ...
    _appendCharRaw(t, e) {
      void 0 === e && (e = {});
      const s = Math.min(
          this.nearestInputPos(0, a.FORCE_RIGHT),
          this.value.length,
        ),
        i = this.enum.filter((e) =>
          this.matchValue(e, this.unmaskedValue + t, s),
        );
      if (i.length) {
        1 === i.length &&
    ...
    remove(t, e) {
      if (
        ...
        return new v();
      const s = Math.min(
        super.nearestInputPos(0, a.FORCE_RIGHT),
        this.value.length,
      );
      let i;
      for (i = t; i >= 0; --i) {
        if (
          this.enum.filter((t) => this.matchValue(t, this.value.slice(s, i), s))
            .length > 1
        )
          break;
      }
  ...
  class w extends C {
    ...
    _updateRegExps() {
      const t = "^" + (this.allowNegative ? "[+|\\-]?" : ""),
        e =
          (this.scale
            ? "(" + n(this.radix) + "\\d{0," + this.scale + "})?"
            : "") + "$";
      ((this._numberRegExp = new RegExp(t + "\\d*" + e)),
        (this._mapToRadixRegExp = new RegExp(
          "[" + this.mapToRadix.map(n).join("") + "]",
          "g",
        )),
  ...
  class L extends b {
    ...
    _update(t) {
      ...
      ((this.repeat =
        null != (e = null != (s = null != a ? a : n.repeat) ? s : this.repeat)
          ? e
          : 1 / 0),
        super._update({
          mask: "m".repeat(
    ...
    _allocateBlock(t) {
      return t < this._blocks.length
        ...
        : this.repeatTo === 1 / 0 || this._blocks.length < this.repeatTo
          ? (this._blocks.push(d(this._blockOpts)),
            (this.mask += "m"),
    ...
    _appendCharRaw(t, e) {
      ...
      for (
        ...
        (r =
          null != (u = this._blocks[o])
            ? u
            : (h = !h && this._allocateBlock(o)));
        ++o
      ) {
        var i, a, u, n;
        const l = r._appendChar(t, {
          ...e,
          _beforeTailState:
            null == (n = e._beforeTailState) || null == (n = n._blocks)
              ? void 0
              : n[o],
        });
        if (l.skip && h) {
    ...
    _trimEmptyTail(t, e) {
      ...
      n &&
        (this._blocks.splice(u - n + 1, n), (this.mask = this.mask.slice(n)));
    }
    reset() {
