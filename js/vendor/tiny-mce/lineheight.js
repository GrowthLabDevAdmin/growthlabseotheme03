  ...
  e.PluginManager.add("lineheight", function (t, n, r) {
    ...
    t.addButton("lineheightselect", function () {
      ...
      return {
          ...
          t.on("nodeChange", function (r) {
            ...
            r.parents.forEach(function (e) {
              n.forEach(function (t) {
                if (i) {
                  if (s.matchNode(e, i, { value: t.value })) {
                    o = t.value;
                  }
                } else {
        ...
        // SECCIÓN CORREGIDA CON TRANSACT Y LA INSTANCIA CORRECTA
        onselect: function () {
          var selectBox = this;
          t.undoManager.transact(function () {
            t.formatter.apply("lineheight", { value: selectBox.value() });
          });
        },
      };
    });
